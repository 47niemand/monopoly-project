 ...
 * The action card has a name, an action {@link Action} (like buying a property,
 * paying rent, etc.), a type of card {@link ActionType} (like optional,
 * obligation, keepable etc.), and a priority.
 *
 * @author dmytromuza
 */
